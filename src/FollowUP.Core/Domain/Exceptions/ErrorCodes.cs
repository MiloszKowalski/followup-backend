namespace FollowUP.Core.Domain
{
    public static class ErrorCodes
    {
        ...
        public static string MaxSmallerThanMin => "max_smaller_than_min";
        ...
        public static string MinGreaterThanMax => "min_greater_than_max";
        ...
        public static string NegativeValue => "negative_value";
