...
namespace InstagramApiSharp.API
{
    ...
    internal static class InstaApiConstants
    {
        ...
        public const string HEADER_ACCEPT_ENCODING = "gzip, deflate";
        ...
        public const string IG_CONNECTION_TYPE = "mobile(UMTS)";
        ...
        public static string ACCEPT_LANGUAGE = "pl-PL, en-US";
