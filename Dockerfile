...
COPY ["src/InstagramApiSharp/InstagramApiSharp.csproj", "src/InstagramApiSharp/"]
...
RUN dotnet build "FollowUP.Api.csproj" -c Release -o /app/build

FROM build AS publish
RUN dotnet publish "FollowUP.Api.csproj" -c Release -o /app/publish
